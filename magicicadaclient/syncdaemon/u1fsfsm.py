...
state_machine = {
    'events': {
        ...
        'AQ_MOVE_ERROR': [
            {
                'ACTION': 'md.create(path=path, uuid=target_uuid, type=type)\naq.query(uuid=target_uuid)',
        ...
        'AQ_UNLINK_ERROR': [
            {
                'ACTION': 'remove the node from trash',
        ...
        'FS_DIR_CREATE': [
            {
                'ACTION': 'mdid = md.create(path=path)\naq.makefile(mdid)',
        ...
        'SV_DIR_NEW': [
            {
                'ACTION': 'md.create(path=path, uuid=uuid, type=type)\naq.query(uuid=uuid)',
                'ACTION_FUNC': 'new_dir',
    ...
    'invalid': [
        {'changed': 'NONE', 'has_metadata': 'F', 'is_directory': 'T'},
        {'changed': 'SERVER', 'has_metadata': 'F', 'is_directory': 'T'},
        {'changed': 'LOCAL', 'has_metadata': 'F', 'is_directory': 'T'},
        {'changed': 'NONE', 'has_metadata': 'F', 'is_directory': 'F'},
        {'changed': 'SERVER', 'has_metadata': 'F', 'is_directory': 'F'},
        {'changed': 'LOCAL', 'has_metadata': 'F', 'is_directory': 'F'},
        {'changed': 'NONE', 'has_metadata': 'F', 'is_directory': 'NA'},
        {'changed': 'SERVER', 'has_metadata': 'F', 'is_directory': 'NA'},
        {'changed': 'LOCAL', 'has_metadata': 'F', 'is_directory': 'NA'},
        {'changed': 'NONE', 'has_metadata': 'T', 'is_directory': 'NA'},
        {'changed': 'SERVER', 'has_metadata': 'T', 'is_directory': 'NA'},
        {'changed': 'LOCAL', 'has_metadata': 'T', 'is_directory': 'NA'},
        {'changed': 'NA', 'has_metadata': 'T', 'is_directory': 'NA'},
        {'changed': 'NA', 'has_metadata': 'T', 'is_directory': 'F'},
        {'changed': 'NA', 'has_metadata': 'T', 'is_directory': 'T'},
        {'changed': 'LOCAL', 'has_metadata': 'T', 'is_directory': 'T'},
        {'changed': 'NA', 'has_metadata': 'F', 'is_directory': 'T'},
        {'changed': 'NA', 'has_metadata': 'F', 'is_directory': 'F'},
    ],
    'parameters': {
        'hash_eq_local_hash': 'hash == md.local_hash',
