...
from magicicadaclient.platform.tests import (
    ConfigTestCase,
    EventsTestCase,
    FileSystemTestCase,
    FoldersTestCase,
...
class StatusTests(StatusTestCase):
    ...
    def test_current_status(self):
        ...
        yield self.assert_method_called(
            self.service.status, 'current_status', result
        )
    ...
    def test_current_uploads(self):
        ...
        result = [{}, STR_STR_DICT]
        yield self.assert_method_called(
            self.service.status, 'current_uploads', result
        )
    ...
    def test_current_downloads(self):
        ...
        result = [STR_STR_DICT, {}]
        yield self.assert_method_called(
            self.service.status, 'current_downloads', result
        )
        self.assert_remote_method(
    ...
    def test_free_space(self):
        ...
        yield self.assert_method_called(
            self.service.status, 'free_space', result, volume_id
        )
        self.assert_remote_method(
...
class EventsTests(EventsTestCase):
    ...
    def test_push_event(self):
        ...
        yield self.assert_method_called(
            self.service.events, 'push_event', result, event_name, event_args
        )
        self.assert_remote_method(
...
class SyncDaemonTests(SyncDaemonTestCase):
    ...
    def test_connect(self):
        """Test connect."""
        result = None
        yield self.assert_method_called(self.service.sync, 'connect', result)
    ...
    def test_disconnect(self):
        ...
        result = None
        yield self.assert_method_called(
            self.service.sync, 'disconnect', result
        )
    ...
    def test_get_homedir(self):
        ...
        yield self.assert_method_called(
            self.service.sync, 'get_homedir', result
        )
    ...
    def test_get_rootdir(self):
        ...
        result = self.root_dir
        yield self.assert_method_called(
            self.service.sync, 'get_rootdir', result
        )
    ...
    def test_get_sharesdir(self):
        ...
        yield self.assert_method_called(
            self.service.sync, 'get_sharesdir', result
        )
    ...
    def test_get_sharesdir_link(self):
        ...
        result = 'foo/bar/baz'
        yield self.assert_method_called(
            self.service.sync, 'get_sharesdir_link', result
        )
    ...
    def test_wait_for_nirvana(self):
        ...
        yield self.assert_method_called(
            self.service.sync, 'wait_for_nirvana', result, last_event_interval
        )
    ...
    def test_quit(self):
        ...
        yield self.assert_method_called(self.service.sync, 'quit', result)
        async_cb = ('reply_handler', 'error_handler')
    ...
    def test_rescan_from_scratch(self):
        ...
        yield self.assert_method_called(
            self.service.sync, 'rescan_from_scratch', result, volume_id
        )
        self.assert_remote_method(
...
class FileSystemTests(FileSystemTestCase):
    ...
    def test_get_metadata(self):
        ...
        path = 'foo/bar'
        yield self.assert_method_called(
            self.service.file_system, 'get_metadata', result, path
        )
        self.assert_remote_method(
    ...
    def test_search_files(self):
        ...
        result = ['path']
        yield self.assert_method_called(
            self.service.file_system, 'search_files', result, 'file'
        )
        self.assert_remote_method(
    ...
    def test_get_dirty_nodes(self):
        ...
        yield self.assert_method_called(
            self.service.file_system, 'get_dirty_nodes', result
        )
        self.assert_remote_method(
...
class SharesTests(SharesTestCase):
    ...
    def test_get_shares(self):
        ...
        yield self.assert_method_called(
            self.service.shares, 'get_shares', result
        )
    ...
    def test_accept_share(self):
        ...
        share_id = '1234'
        yield self.assert_method_called(
            self.service.shares, 'accept_share', result, share_id
        )
    ...
    def test_reject_share(self):
        ...
        share_id = '1234'
        yield self.assert_method_called(
            self.service.shares, 'reject_share', result, share_id
        )
    ...
    def test_delete_share(self):
        ...
        share_id = '1234'
        yield self.assert_method_called(
            self.service.shares, 'delete_share', result, share_id
        )
    ...
    def test_subscribe(self):
        ...
        share_id = '1234'
        yield self.assert_method_called(
            self.service.shares, 'subscribe', result, share_id
        )
        self.assert_remote_method(
    ...
    def test_unsubscribe(self):
        ...
        share_id = '1234'
        yield self.assert_method_called(
            self.service.shares, 'unsubscribe', result, share_id
        )
        self.assert_remote_method(
    ...
    def test_create_shares(self):
        ...
        actual = yield client.call_method(
            'create_shares', path, usernames, name, access_level
        )
        self.assertEqual(result, actual)

        expected = [
            (('path', 'pepe', 'name', 'access_level'), {}),
    ...
    def test_refresh_shares(self):
        ...
        result = None
        yield self.assert_method_called(
            self.service.shares, 'refresh_shares', result
        )
    ...
    def test_get_shared(self):
        ...
        result = [{'share_id': '1'}, {'share_id': '2'}]
        yield self.assert_method_called(
            self.service.shares, 'get_shared', result
        )
...
class ConfigTests(ConfigTestCase):
    ...
    def test_enabled(self):
        ...
        result = False
        yield self.assert_method_called(self.service.config, method, result)
...
class ThrottlingConfigTests(ConfigTests):
    ...
    def test_get_throttling_limits_unset(self):
        ...
        yield self.assert_method_called(
            self.service.config, 'get_throttling_limits', result
        )
...
class FoldersTests(FoldersTestCase):
    ...
    def test_create(self):
        ...
        path = 'foo'
        yield self.assert_method_called(
            self.service.folders, 'create', result, path
        )
        self.assert_remote_method(
    ...
    def test_delete(self):
        ...
        folder_id = '1234'
        yield self.assert_method_called(
            self.service.folders, 'delete', result, folder_id
        )
        self.assert_remote_method(
    ...
    def test_validate_path(self):
        ...
        path = 'test'
        yield self.assert_method_called(
            self.service.folders, 'validate_path', result, path
        )
        self.assert_remote_method(
    ...
    def test_get_folders(self):
        ...
        yield self.assert_method_called(
            self.service.folders, 'get_folders', result
        )
        self.assert_remote_method(
    ...
    def test_subscribe(self):
        ...
        folder_id = '1234'
        yield self.assert_method_called(
            self.service.folders, 'subscribe', result, folder_id
        )
    ...
    def test_unsubscribe(self):
        ...
        folder_id = '1234'
        yield self.assert_method_called(
            self.service.folders, 'unsubscribe', result, folder_id
        )
    ...
    def test_get_info(self):
        ...
        path = 'yadda'
        yield self.assert_method_called(
            self.service.folders, 'get_info', result, path
        )
        self.assert_remote_method(
    ...
    def test_refresh_volumes(self):
        ...
        result = None
        yield self.assert_method_called(
            self.service.folders, 'refresh_volumes', result
        )
...
class PublicFilesTests(PublicFilesTestCase):
    ...
    def test_get_public_files(self):
        ...
        result = None
        yield self.assert_method_called(
            self.service.public_files, 'get_public_files', result
        )
        self.assert_remote_method(
