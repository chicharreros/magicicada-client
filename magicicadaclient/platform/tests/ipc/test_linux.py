...
from magicicadaclient.platform.ipc import linux as dbus_interface
from magicicadaclient.platform.ipc.linux import (
    DBusExposedObject,
...
from magicicadaclient.platform.tools.linux import DBusClient
